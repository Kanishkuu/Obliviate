...
class LoRAConfig:
    ...
    alpha: int = 16
    dropout: float = 0.0
    target_modules: Optional[list[str]] = None  # auto if None
...
class TrainConfig:
    ...
    dataset_field_map: Optional[Dict[str, str]] = None  # e.g., {"prompt":"input","completion":"output"}
    ...
    eval_split: Optional[str] = None  # name of eval split if present

    # Optional instruction format
